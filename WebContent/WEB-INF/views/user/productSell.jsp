		                ...
		                <div class="col-lg-3 col-md-6 special-grid bulbs">
		                    <div class="products-single fix">
		                        <div class="box-img-hover">
		                            <div class="type-lb">
		                              <p class="sale">${u.tenSP}</p>
		                              <p  class="sale">${u.thuongHieu}</p>
		                            </div>
		                            <img style="display:block;  max-width: 500px; max-height: 300px;" img src="images/${u.hinhAnh}"class="img-fluid" alt="${u.tenSP}">
		                            <div class="type-lb">
		                              <p  class="sale">${u.donGia} VNĐ</p>
		                            </div>
		                            <div class="mask-icon">
		                                
		                                <a class="cart"  href="ShopMayTinh/user/cart/${u.maSP}.htm">Thêm vào giỏ hàng</a>
		                            </div>
		                        </div>
		                    </div>
		                </div>
