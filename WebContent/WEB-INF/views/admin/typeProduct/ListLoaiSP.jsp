...
<html>
	...
	<body>
		...
		<div class = "ListLoaiSP">
				<button> 
					<a href = "ShopMayTinh/admin/typeProduct/insert.htm">
						Thêm 
					</a>
				</button>
			<table border="1" style="width:70%">
				...
				<c:forEach var="u" items="${listLoaiSP}"> 
					<tr>
						<td>${u.maLoai}</td> 
						<td>${u.tenLoai}</td>
						<td> <a href= "ShopMayTinh/admin/typeProduct/${u.maLoai}.htm">Xóa</a></td>
						<td> <a href= "ShopMayTinh/admin/typeProduct/update/${u.maLoai}.htm">Sửa</a></td>
					</tr>
				</c:forEach>
